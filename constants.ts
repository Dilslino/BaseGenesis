...
export const MOCK_LEADERBOARD: LeaderboardEntry[] = [
  { rank: 1, name: "jessepollak", address: "0x8C...9d2", status: UserRank.GENESIS_PIONEER, days: 580, isLegend: true, fid: 99 },
  { rank: 2, name: "dwr.eth", address: "0x5b...A10", status: UserRank.GENESIS_PIONEER, days: 575, isLegend: true, fid: 3 },
  { rank: 3, name: "vitalik.eth", address: "0xd8...045", status: UserRank.GENESIS_PIONEER, days: 540, isLegend: true, fid: 5650 },
  { rank: 4, name: "base", address: "0x12...999", status: UserRank.EARLY_SETTLER, days: 480, isLegend: true, fid: 12142 },
  { rank: 5, name: "coinbase", address: "0x77...777", status: UserRank.EARLY_SETTLER, days: 450, isLegend: true, fid: 1234 },
  { rank: 6, name: "anon.base", address: "0x99...123", status: UserRank.EARLY_SETTLER, days: 420, isLegend: false },
  { rank: 7, name: "builder.eth", address: "0xAB...456", status: UserRank.BASE_CITIZEN, days: 380, isLegend: false },
  { rank: 8, name: "degen.base", address: "0xCD...789", status: UserRank.BASE_CITIZEN, days: 350, isLegend: false },
  { rank: 9, name: "nft_whale", address: "0xEF...012", status: UserRank.BASE_CITIZEN, days: 320, isLegend: false },
